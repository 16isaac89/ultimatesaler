...
<li class="submenu">
<a href="javascript:void(0);"><img src="{{asset('assets/img/icons/product.svg')}}" alt="img"><span> Inventory</span> <span class="menu-arrow"></span></a>
<ul>
@can('product_access')
<li><a href="{{ route("admin.products.index") }}" class="nav-link {{ request()->is("admin/products") || request()->is("admin/products/*") ? "active" : "" }}">Product List</a></li>
@endcan
@can('product_category_access')
<li><a href="{{ route("admin.product-categories.index") }}" class="nav-link {{ request()->is("admin/product-categories") || request()->is("admin/product-categories/*") ? "active" : "" }}">Category List</a></li>
@endcan
@can('brand_access')
<li><a href="{{ route("admin.brands.index") }}" class="nav-link {{ request()->is("admin/brands") || request()->is("admin/brands/*") ? "active" : "" }}">Brand List</a></li>
@endcan
@can('unit_access')
<li><a href="{{ route("admin.units.index") }}" class="nav-link {{ request()->is("admin/units") || request()->is("admin/units/*") ? "active" : "" }}">Units</a></li>
@endcan
@can('variation_access')
<li><a href="{{ route("admin.variations.index") }}" class="nav-link {{ request()->is("admin/variations") || request()->is("admin/variations/*") ? "active" : "" }}">Variations</a></li>
@endcan
</ul>
</li>
@endcan
